...
const ONGOING_PROJECTS = [
  ...
  },
  {
    id: 2,
    name: "JJ Enclave",
    subtitle: "Bogadi Road, Mysore",
    type: "RERA Registered",
    tagline: "Flagship Residential Layout",
    highlights: ["Premium plots in fastest-growing area", "Home loans up to 80%", "Access to schools & malls"],
    features: ["Well-planned roads & street lighting", "Close to Mysore Ring Road", "Excellent neighborhood", "Rapidly developing area"],
    loan: "Up to 80%",
    approval: "RERA: PRM/KA/RERA/1251/450/PR/170101/008001",
    image: "/Img/jjNagar.png",
    link: "/project/jjenclave",
  },
  {
    id: 3,
  ...
  },
  {
    id: 5,
    name: "Vanasiri",
    subtitle: "Jettihundi, Mysore",
    type: "RERA Registered",
    tagline: "Premium Plotted Development",
    highlights: ["Loan up to 85%", "Ready-to-build plots", "Lush green surroundings"],
    features: ["Modern amenities", "Peaceful natural setting", "City college proximity", "Appreciation value"],
    loan: "Up to 85%",
    approval: "RERA: PRM/KA/RERA/1254/100/PR/190708/011011",
    image: "/Img/vana.png",
    link: "/project/vanasiri",
  },
];
