    ...
    <div className="bg-[#F4F7FB] text-[#1F2937] font-sans overflow-hidden">
      ...
      <section className="flex flex-col md:flex-row items-center md:items-start justify-between max-w-7xl mx-auto py-20 px-6 md:px-16 gap-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-semibold text-[#1F2937]">
            About <span className="text-[#1A3A5C]">Vanasiri Layout</span>
          </h2>
          <p className="text-gray-600 leading-relaxed text-lg">
            Looking for plots for sale in Jettihundi Mysore? Your search ends
            here! <span className="text-[#1A3A5C] font-semibold">Vanasiri</span>{" "}
          ...
          <p className="text-gray-600 leading-relaxed text-lg">
            ...
            <span className="text-[#1A3A5C] font-semibold">SVP Developers</span>
      ...
      <section className="py-20 px-6 md:px-20 max-w-7xl mx-auto">
        <div className="relative text-center mb-12">
          ...
          >
            Vanasiri Layout <span className="text-[#1A3A5C]">Amenities</span>
          </motion.h2>
          <motion.div
