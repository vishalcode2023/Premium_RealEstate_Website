    ...
    <div className="bg-[#F4F7FB] text-[#1F2937] font-sans overflow-hidden">
      ...
      <section className="flex flex-col md:flex-row items-center md:items-start justify-between max-w-7xl mx-auto py-20 px-6 md:px-16 gap-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-semibold text-[#1F2937]">
            About <span className="text-[#1A3A5C]">My Nagar Layout</span>
          </h2>
      ...
      <section className="py-20 px-6 md:px-20 max-w-7xl mx-auto">
        <div className="relative text-center mb-12">
          ...
          >
            Premium <span className="text-[#1A3A5C]">Amenities</span>
          </motion.h2>
          <motion.div
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {amenities.map((item, i) => (
            ...
            >
              <div className="w-20 h-20 mb-3 flex items-center justify-center rounded-full bg-gradient-to-br from-[#1A3A5C] to-[#142d47] text-white text-4xl shadow-md
