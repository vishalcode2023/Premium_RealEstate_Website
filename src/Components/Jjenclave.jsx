...
import {
  ...
  Trees,
  Droplet,
  ShieldCheck, // Used for 24/7 Security
  Star, // Used for Street Lights
  Landmark,
  GraduationCap,
  ArrowRight,
  CheckCircle, // Used for Drainage System
  Footprints, // Jogging Track
  Utensils, // Restaurants (if you had this, otherwise not used in this specific set)
  Banknote, // Banks (if you had this)
  Hospital, // Hospitals (if you had this)
  CreditCard, // ATMs (if you had this)
  School, // Schools (if you had this)
  Smile, // Children's Play Area (if you decide to use it)
  Building, // Placeholder for general amenity or feature (not currently used)
  Briefcase, // Placeholder for investment (not currently used)
  Lock, // Specifically for Gated Community
} from "lucide-react";
import Navbar from "../Router/Navbar";
import Footer from "./Footer";

const Jjenclave = () => {
  // Features for "Why Invest in Mysore?" - same as MyNagar
  const features = [
  ...
  // Amenities for JJ Enclave - Customized for the new request
  const jjenclaveAmenities = [
    { title: "Gated Community", icon: <Lock size={28} /> },
    { title: "Wide Roads", icon: <Route size={28} /> },
    { title: "Electricity Supply", icon: <Droplet size={28} /> }, // Reusing Droplet for utility
    { title: "24/7 Security", icon: <ShieldCheck size={28} /> },
    { title: "Landscaped Parks", icon: <Trees size={28} /> },
    { title: "Water Connection", icon: <Droplet size={28} /> }, // Reusing Droplet for water utility
    { title: "Drainage System", icon: <CheckCircle size={28} /> },
    { title: "Street Lights", icon: <Star size={28} /> },
  ];
  ...
  return (
    <div className="bg-[#f8f6f1] text-[#1a1a1a] font-sans overflow-hidden">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/Img/jjNagar.png')" }}
      >
      ...
      {/* ✅ About Section (Left image + right text) - Adapted for JJ Enclave content */}
      <section className="flex flex-col md:flex-row items-center md:items-start justify-between max-w-7xl mx-auto py-20 px-6 md:px-16 gap-12">
        ...
        >
          <img
            src="/Img/jjNagar.png" // Update image path
            alt="JJ Enclave Bogadi Road Mysore"
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed text-lg">
            ...
            location for your dream home or investment.
          </p>
          <p className="text-gray-600 leading-relaxed text-lg">
            With{" "}
            <span className="text-[#f4b860] font-semibold">
            ...
            Enclave and our other real estate projects in Mysore by browsing our
            website. Contact us today to schedule a visit.
          </p>
      ...
      {/* ✅ Amenities Section - For JJ Enclave (Similar to MyNagar's new style) */}
      ...
      {/* ✅ Why Invest Section - Same as MyNagar */}
      <section className="py-20 px-6 md:px-20 max-w-7xl mx-auto">
        <div className="relative text-center mb-12">
          <motion.h2
            initial={{ opacity: 0, y: -20 }}
